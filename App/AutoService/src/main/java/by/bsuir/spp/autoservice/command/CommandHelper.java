...
public enum CommandHelper {
    ...
    TO_ADD_ORDER_PAGE(new ToPageCommand(PagePath.ADD_DETAIL_ORDER), RoleEnum.MECHANIC),
    ...
    SAVE_REPAIR_REPORT(new SaveRepairReportCommand(), RoleEnum.MECHANIC),
    SAVE_DETAIL_ORDER(new SaveOrderDetailApplicationCommand(), RoleEnum.MECHANIC),
