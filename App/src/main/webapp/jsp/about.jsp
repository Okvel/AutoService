                            ...
                            <div class="navbar">
                                ...
                                <div class="nav-collapse collapse">
                                    <ul class="nav nav-pills ddmenu">
                                        ...
                                        <li class="dropdown active"><a href="to_about_page">About Us</a></li>
                                        <li class="dropdown"><a href="">Feedback</a></li>
                                        <li class="dropdown"><a href="to_service_list_page">Service List</a></li>
    ...
    <div class="container">
        ...
        <div class="divPanel page-content">
            ...
            <div class="breadcrumbs">
                <a href="to_home_page">Home</a> &nbsp;/&nbsp; <span>Simple</span>
            </div>
            ...
            <div class="row-fluid">
                ...
                <div class="span4 sidebar">
                    ...
                    <div class="sidebox">
                        ...
                        <h5>Wheels repair ( 40% )</h5>
                        <div class="progress progress-info">
                            <div class="bar" style="width: 40%"></div>
                        </div>

                        <h5>Transmission ( 80% )</h5>
