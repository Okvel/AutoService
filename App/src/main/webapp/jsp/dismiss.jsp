                        ...
                        <div class="navbar">
                            ...
                            <div class="nav-collapse collapse">
                                <ul class="nav nav-pills ddmenu">
                                    ...
                                    <li class="dropdown active"><a href="show_dismiss">Dismiss</a></li>
        ...
        <div class="sidebox">
            ...
            <p>
                <form action="dismiss" method="post">
                    <select class="pr-select" name="id">
                        <s:iterator value="users">
                            <option value="<s:property value="id"/>">
                                    <s:property value="personInfo.lastName"/> <s:property value="personInfo.firstName"/>
