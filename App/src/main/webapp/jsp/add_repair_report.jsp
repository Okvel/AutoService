                        ...
                        <div class="navbar">
                            ...
                            <div class="nav-collapse collapse">
                                <ul class="nav nav-pills ddmenu">
                                    ...
                                    <li class="dropdown active"><a href="show_add_repair_report">Repair report</a></li>
                                    <li class="dropdown"><a href="to_add_order_page">Details order</a></li>
...
<div class="container">
    <div class="sidebox">
        ...
        <form class="clearfix" action="save_repair_report" method="post">
            <select name="car_id" class="form-control">
                <s:iterator value="cars" var="car">
                    <option value="<s:property value="#car.id"/>"><s:property value="#car.model.vendor"/> <s:property value="#car.model.name"/> <s:property value="#car.registrationNumber"/></option>
                </s:iterator>
            </select><br/>
