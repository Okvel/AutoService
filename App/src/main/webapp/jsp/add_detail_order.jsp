                        ...
                        <div class="navbar">
                            ...
                            <div class="nav-collapse collapse">
                                <ul class="nav nav-pills ddmenu">
                                    ...
                                    <li class="dropdown"><a href="show_add_repair_report">Repair report</a></li>
                                    <li class="dropdown active"><a href="to_add_order_page">Details order</a></li>
...
<div class="container">
    <div class="sidebox">
        ...
        <form class="clearfix" action="save_detail_order" method="post">
