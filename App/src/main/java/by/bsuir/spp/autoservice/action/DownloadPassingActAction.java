...
public class DownloadPassingActAction implements Action {
    private static Logger logger = Logger.getLogger(DownloadPassingActAction.class);
    ...
    public String execute() throws Exception {
        ...
        try {
            link = service.getPassingActDocument(documentFormat);
